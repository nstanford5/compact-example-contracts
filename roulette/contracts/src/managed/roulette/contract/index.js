...
(function (ReadyState) {
  ReadyState[ReadyState['NOT_READY'] = 0] = 'NOT_READY';
  ReadyState[ReadyState['READY'] = 1] = 'READY';
...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    this.circuits = {
      placeBet: (...args_1) => {
        ...
        const partialProofData = {
          input: {
            value: _descriptor_2.toValue(amount_0).concat(_descriptor_2.toValue(number_0)),
      ...
      revealWinningNumber: (...args_1) => {
        ...
        const partialProofData = {
          input: {
            value: _descriptor_2.toValue(winningNum_0).concat(_descriptor_0.toValue(_sk_0)),
      ...
      checkForWin: (...args_1) => {
        if (args_1.length !== 3) {
          throw new __compactRuntime.CompactError(`checkForWin: expected 3 arguments (as invoked from Typescript), received ${args_1.length}`);
        }
        const contextOrig_0 = args_1[0];
        const number_0 = args_1[1];
        const amount_0 = args_1[2];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('checkForWin',
                                     'argument 1 (as invoked from Typescript)',
                                     'roulette.compact line 80 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        if (!(typeof(number_0) === 'bigint' && number_0 >= 0n && number_0 <= 255n)) {
        ...
        const partialProofData = {
          input: {
            value: _descriptor_2.toValue(number_0).concat(_descriptor_2.toValue(amount_0)),
            alignment: _descriptor_2.alignment().concat(_descriptor_2.alignment())
          },
          output: undefined,
          publicTranscript: [],
        ...
        const result_0 = this._checkForWin_0(context,
                                             partialProofData,
                                             number_0,
                                             amount_0);
        partialProofData.output = { value: [], alignment: [] };
    ...
    this.impureCircuits = {
      ...
      checkForWin: this.circuits.checkForWin
    };
  }
  initialState(...args_0) {
    if (args_0.length !== 4) {
    ...
    if (!(typeof(setMaxBet_0) === 'bigint' && setMaxBet_0 >= 0n && setMaxBet_0 <= 255n)) {
      __compactRuntime.typeError('Contract state constructor',
                                 'argument 1 (argument 2 as invoked from Typescript)',
                                 'roulette.compact line 41 char 1',
                                 'Uint<0..256>',
                                 setMaxBet_0)
    }
    ...
    state_0.setOperation('checkForWin', new __compactRuntime.ContractOperation());
                                      ...
                                      [
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_2.toValue(1n),
                                                                                              alignment: _descriptor_2.alignment() }).encode() } },
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_2.toValue(setMaxBet_0),
                                                                                              alignment: _descriptor_2.alignment() }).encode() } },
                                       { ins: { cached: false, n: 1 } }]);
    const hash_0 = this._commitWithSk_0(__compactRuntime.convertFieldToBytes(32,
                                                                             _winningNum_0,
                                                                             'roulette.compact line 51 char 31'),
                                        _sk_0);
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
  ...
  _placeBet_0(context, partialProofData, amount_0, number_0) {
                                                ...
                                                path: [
                                                       { tag: 'value',
                                                         value: { value: _descriptor_2.toValue(5n),
                                                                  alignment: _descriptor_2.alignment() } }] } },
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_2.toValue(number_0),
                                                                                              alignment: _descriptor_2.alignment() }).encode() } },
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newMap(
                                                          new __compactRuntime.StateMap()
                                                ...
                                                path: [
                                                       { tag: 'value',
                                                         value: { value: _descriptor_2.toValue(5n),
                                                                  alignment: _descriptor_2.alignment() } },
                                                       { tag: 'value',
                                                         value: { value: _descriptor_2.toValue(number_0),
                                                                  alignment: _descriptor_2.alignment() } }] } },
                                       { push: { storage: false,
  ...
  _revealWinningNumber_0(context, partialProofData, winningNum_0, _sk_0) {
    ...
    const hash_0 = this._commitWithSk_0(__compactRuntime.convertFieldToBytes(32,
                                                                             winningNum_0,
                                                                             'roulette.compact line 74 char 31'),
                                        _sk_0);
                                      ...
                                      [
                                       ...
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_2.toValue(winningNum_0),
                                                                                              alignment: _descriptor_2.alignment() }).encode() } },
                                       { ins: { cached: false, n: 1 } }]);
    const tmp_0 = this._getColor_0(_descriptor_2.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                             partialProofData,
                                                                                             [
                                                                                              { dup: { n: 0 } },
                                                                                              { idx: { cached: false,
  ...
  _checkForWin_0(context, partialProofData, number_0, amount_0) {
                                                                                                ...
                                                                                                path: [
                                                                                                       ...
                                                                                                       { tag: 'value',
                                                                                                         value: { value: _descriptor_2.toValue(number_0),
                                                                                                                  alignment: _descriptor_2.alignment() } }] } },
                                                                                       { push: { storage: false,
                                                                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_1.toValue(pubAddress_0),
                                                                                                                                              alignment: _descriptor_1.alignment() }).encode() } },
                                                                                       'member',
                                                                                       { popeq: { cached: true,
                                                                                                  result: undefined } }]).value),
                            "You don't have a winning number");
    const bet_0 = _descriptor_2.fromValue(__compactRuntime.queryLedgerState(context,
                                                                            partialProofData,
                                                                            [
                                                                             { dup: { n: 0 } },
                                                                             { idx: { cached: false,
                                                                             ...
                                                                             { idx: { cached: false,
                                                                                      ...
                                                                                      path: [
                                                                                             { tag: 'value',
                                                                                               value: { value: _descriptor_1.toValue(pubAddress_0),
                                                                                                        alignment: _descriptor_1.alignment() } }] } },
                                                                             { popeq: { cached: false,
                                                                                        result: undefined } }]).value);
    __compactRuntime.queryLedgerState(context,
                                      ...
                                      [
                                       ...
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_1.toValue(pubAddress_0),
                                                                                              alignment: _descriptor_1.alignment() }).encode() } },
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_2.toValue(bet_0),
                                                                                              alignment: _descriptor_2.alignment() }).encode() } },
                                       { ins: { cached: false, n: 1 } },
                                       { ins: { cached: true, n: 1 } }]);
    return [];
  ...
  _getColor_0(num_0) {
    if (this._equal_3(num_0, 0n)) {
      return 0;
    } else {
      if (this._equal_4(num_0, 1n) || this._equal_5(num_0, 3n)
          ||
          this._equal_6(num_0, 5n)
          ||
          this._equal_7(num_0, 7n)
          ||
          this._equal_8(num_0, 9n)
          ||
          this._equal_9(num_0, 11n)
          ||
          this._equal_10(num_0, 13n)
          ||
          this._equal_11(num_0, 15n)
          ||
          this._equal_12(num_0, 17n)
          ||
          this._equal_13(num_0, 19n)
          ||
          this._equal_14(num_0, 21n)
          ||
          this._equal_15(num_0, 23n)
          ||
          this._equal_16(num_0, 25n)
          ||
          this._equal_17(num_0, 27n)
          ||
          this._equal_18(num_0, 29n)
          ||
          this._equal_19(num_0, 31n)
          ||
          this._equal_20(num_0, 33n)
          ||
          this._equal_21(num_0, 35n))
      {
        return 1;
      } else {
        return 2;
  ...
  return {
    ...
    playerList: {
      ...
      member(...args_0) {
        ...
        if (!(typeof(key_0) === 'bigint' && key_0 >= 0n && key_0 <= 255n)) {
          __compactRuntime.typeError('member',
                                     'argument 1',
                                     'roulette.compact line 35 char 1',
                                     'Uint<0..256>',
                                     key_0)
        }
        return _descriptor_3.fromValue(__compactRuntime.queryLedgerState(context,
      ...
      lookup(...args_0) {
        ...
        if (state.asArray()[5].asMap().get({ value: _descriptor_2.toValue(key_0),
        ...
        return {
          ...
          member(...args_1) {
            ...
            if (!(typeof(key_1) === 'object' && key_1.bytes.buffer instanceof ArrayBuffer && key_1.bytes.BYTES_PER_ELEMENT === 1 && key_1.bytes.length === 32)) {
              __compactRuntime.typeError('member',
                                         'argument 1',
                                         'roulette.compact line 35 char 40',
          ...
          [Symbol.iterator](...args_1) {
            ...
            const self_0 = state.asArray()[5].asMap().get({ value: _descriptor_2.toValue(key_0),
                                                            alignment: _descriptor_2.alignment() });
    ...
    winnerList: {
      ...
      member(...args_0) {
        ...
        if (!(typeof(key_0) === 'object' && key_0.bytes.buffer instanceof ArrayBuffer && key_0.bytes.BYTES_PER_ELEMENT === 1 && key_0.bytes.length === 32)) {
          __compactRuntime.typeError('member',
                                     'argument 1',
                                     'roulette.compact line 37 char 1',
                                     'struct ZswapCoinPublicKey<bytes: Bytes<32>>',
                                     key_0)
        }
        return _descriptor_3.fromValue(__compactRuntime.queryLedgerState(context,
