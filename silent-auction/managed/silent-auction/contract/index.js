...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    this.circuits = {
      bid: (...args_1) => {
        if (args_1.length !== 3) {
          throw new __compactRuntime.CompactError(`bid: expected 3 arguments (as invoked from Typescript), received ${args_1.length}`);
        }
        ...
        const partialProofData = {
          input: {
            value: _descriptor_0.toValue(pk_0).concat(_descriptor_3.toValue(bidAmount_0)),
      ...
      revealWin: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('revealWin',
                                     'argument 1 (as invoked from Typescript)',
                                     'silent-auction.compact line 36 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        if (!(typeof(minPrice_0) === 'bigint' && minPrice_0 >= 0n && minPrice_0 <= 255n)) {
          __compactRuntime.typeError('revealWin',
                                     'argument 1 (argument 2 as invoked from Typescript)',
                                     'silent-auction.compact line 36 char 1',
                                     'Uint<0..256>',
        ...
        const partialProofData = {
          input: {
            value: _descriptor_3.toValue(minPrice_0).concat(_descriptor_0.toValue(sk_0)),
  ...
  initialState(...args_0) {
    ...
    if (!(sk_0.buffer instanceof ArrayBuffer && sk_0.BYTES_PER_ELEMENT === 1 && sk_0.length === 32)) {
      __compactRuntime.typeError('Contract state constructor',
                                 'argument 1 (argument 2 as invoked from Typescript)',
                                 'silent-auction.compact line 16 char 1',
                                 'Bytes<32>',
                                 sk_0)
    }
    if (!(typeof(minPrice_0) === 'bigint' && minPrice_0 >= 0n && minPrice_0 <= 255n)) {
                                      ...
                                      [
                                       ...
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_5.toValue(tmp_0),
                                                                                              alignment: _descriptor_5.alignment() }).encode() } },
                                       { ins: { cached: false, n: 1 } }]);
    const tmp_1 = this._commitWithSk_0(__compactRuntime.convertFieldToBytes(32,
                                                                            minPrice_0,
                                                                            'silent-auction.compact line 18 char 32'),
                                       sk_0);
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
  ...
  _bid_0(context, partialProofData, pk_0, bidAmount_0) {
                                                                            ...
                                                                            path: [
                                                                                   { tag: 'value',
                                                                                     value: { value: _descriptor_3.toValue(3n),
                                                                                              alignment: _descriptor_3.alignment() } }] } },
                                                                   { push: { storage: false,
                                                                             value: __compactRuntime.StateValue.newCell({ value: _descriptor_0.toValue(publicPk_0),
                                                                                                                          alignment: _descriptor_0.alignment() }).encode() } },
                                                                   'member',
                                                                   { popeq: { cached: true,
                                                                              result: undefined } }]).value))
      ...
      __compactRuntime.assert(_descriptor_3.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                        ...
                                                                                        [
                                                                                         ...
                                                                                         { idx: { cached: false,
                                                                                                  ...
                                                                                                  path: [
                                                                                                         { tag: 'value',
                                                                                                           value: { value: _descriptor_0.toValue(publicPk_0),
  ...
  _revealWin_0(context, partialProofData, minPrice_0, sk_0) {
    ...
    __compactRuntime.assert(this._equal_1(_descriptor_1.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                                    ...
                                                                                                    [
                                                                                                     ...
                                                                                                     { popeq: { cached: true,
                                                                                                                result: undefined } }]).value),
                                          9n),
                            'Bidding is not complete until 9 bids have been received');
    __compactRuntime.assert(this._equal_2(this._commitWithSk_0(__compactRuntime.convertFieldToBytes(32,
                                                                                                    minPrice_0,
                                                                                                    'silent-auction.compact line 39 char 25'),
                                                               sk_0),
  ...
  _commitWithSk_0(minPrice_0, sk_0) {
    return this._persistentHash_0([minPrice_0, sk_0]);
  }
  _publicKey_0(sk_0) {
      ...
      member(...args_0) {
        ...
        if (!(key_0.buffer instanceof ArrayBuffer && key_0.BYTES_PER_ELEMENT === 1 && key_0.length === 32)) {
          __compactRuntime.typeError('member',
                                     'argument 1',
                                     'silent-auction.compact line 12 char 1',
                                     'Bytes<32>',
                                     key_0)
        }
        return _descriptor_4.fromValue(__compactRuntime.queryLedgerState(context,
  ...
  publicKey: (...args_0) => {
    ...
    if (!(sk_0.buffer instanceof ArrayBuffer && sk_0.BYTES_PER_ELEMENT === 1 && sk_0.length === 32)) {
      __compactRuntime.typeError('publicKey',
                                 'argument 1',
                                 'silent-auction.compact line 50 char 1',
                                 'Bytes<32>',
                                 sk_0)
    }
