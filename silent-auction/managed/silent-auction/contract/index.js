    ...
    this.circuits = {
      bid: (...args_1) => {
        ...
        const partialProofData = {
          input: {
            value: _descriptor_0.toValue(pk_0).concat(_descriptor_1.toValue(bidAmount_0)),
      ...
      revealWin: (...args_1) => {
        ...
        const partialProofData = {
          input: {
            value: _descriptor_1.toValue(minPrice_0).concat(_descriptor_0.toValue(sk_0)),
                                      ...
                                      [
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_1.toValue(2n),
                                                                                              alignment: _descriptor_1.alignment() }).encode() } },
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_1.toValue(minPrice_0),
                                                                                              alignment: _descriptor_1.alignment() }).encode() } },
                                       { ins: { cached: false, n: 1 } }]);
  ...
  publicKey: (...args_0) => {
    ...
    if (!(sk_0.buffer instanceof ArrayBuffer && sk_0.BYTES_PER_ELEMENT === 1 && sk_0.length === 32)) {
      __compactRuntime.typeError('publicKey',
                                 'argument 1',
                                 'silent-auction.compact line 49 char 1',
                                 'Bytes<32>',
                                 sk_0)
    }
