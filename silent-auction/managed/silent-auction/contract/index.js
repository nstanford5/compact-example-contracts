...
export class Contract {
      ...
      closeAuction: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('closeAuction',
                                     'argument 1 (as invoked from Typescript)',
                                     'silent-auction.compact line 59 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
      ...
      revealWin: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('revealWin',
                                     'argument 1 (as invoked from Typescript)',
                                     'silent-auction.compact line 67 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        if (!(typeof(minPrice_0) === 'bigint' && minPrice_0 >= 0n && minPrice_0 <= 255n)) {
  ...
  initialState(...args_0) {
    ...
    if (!(typeof(_minPrice_0) === 'bigint' && _minPrice_0 >= 0n && _minPrice_0 <= 255n)) {
    ...
    if (!(typeof(maxBidCount_0) === 'bigint' && maxBidCount_0 >= 0n && maxBidCount_0 <= 255n)) {
      __compactRuntime.typeError('Contract state constructor',
  ...
  _revealWin_0(context, partialProofData, minPrice_0) {
    ...
    const hashedPrice_0 = this._commitWithSk_0(__compactRuntime.convertFieldToBytes(32,
                                                                                    minPrice_0,
                                                                                    'silent-auction.compact line 72 char 38'),
                                               _sk_0);
  ...
  publicKey: (...args_0) => {
    ...
    if (!(_sk_0.buffer instanceof ArrayBuffer && _sk_0.BYTES_PER_ELEMENT === 1 && _sk_0.length === 32)) {
      __compactRuntime.typeError('publicKey',
                                 'argument 1',
                                 'silent-auction.compact line 91 char 1',
                                 'Bytes<32>',
                                 _sk_0)
    }
