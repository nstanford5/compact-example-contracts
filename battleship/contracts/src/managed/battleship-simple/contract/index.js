...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    if (typeof(witnesses_0.setBoard) !== 'function') {
      throw new __compactRuntime.CompactError('first (witnesses) argument to Contract constructor does not contain a function-valued field named setBoard');
    }
    if (typeof(witnesses_0.checkBoard) !== 'function') {
      throw new __compactRuntime.CompactError('first (witnesses) argument to Contract constructor does not contain a function-valued field named checkBoard');
    }
      ...
      acceptGame: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('acceptGame',
                                     ...
                                     'battleship-simple.compact line 78 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        ...
        const partialProofData = {
          input: {
            value: _descriptor_2.toValue(_x1_0).concat(_descriptor_2.toValue(_x2_0).concat(_descriptor_0.toValue(_sk_0))),
      ...
      player1Shoot: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('player1Shoot',
                                     'argument 1 (as invoked from Typescript)',
                                     'battleship-simple.compact line 101 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
      ...
      player2Shoot: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('player2Shoot',
                                     'argument 1 (as invoked from Typescript)',
                                     'battleship-simple.compact line 117 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        if (!(typeof(x_0) === 'bigint' && x_0 >= 0n && x_0 <= 255n)) {
      ...
      checkBoard1: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('checkBoard1',
                                     'argument 1 (as invoked from Typescript)',
                                     'battleship-simple.compact line 132 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        if (!(_sk_0.buffer instanceof ArrayBuffer && _sk_0.BYTES_PER_ELEMENT === 1 && _sk_0.length === 32)) {
      ...
      checkBoard2: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('checkBoard2',
                                     'argument 1 (as invoked from Typescript)',
                                     'battleship-simple.compact line 164 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        if (!(_sk_0.buffer instanceof ArrayBuffer && _sk_0.BYTES_PER_ELEMENT === 1 && _sk_0.length === 32)) {
  ...
  initialState(...args_0) {
    ...
    if (!(typeof(_x1_0) === 'bigint' && _x1_0 >= 0n && _x1_0 <= 255n)) {
      __compactRuntime.typeError('Contract state constructor',
                                 'argument 1 (argument 2 as invoked from Typescript)',
                                 'battleship-simple.compact line 55 char 1',
                                 'Uint<0..256>',
                                 _x1_0)
    }
    if (!(typeof(_x2_0) === 'bigint' && _x2_0 >= 0n && _x2_0 <= 255n)) {
    ...
    const hash1_0 = this._commitBoardSpace_0(__compactRuntime.convertFieldToBytes(32,
                                                                                  _x1_0,
                                                                                  'battleship-simple.compact line 64 char 36'),
                                             _sk_0);
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
    ...
    const hash2_0 = this._commitBoardSpace_0(__compactRuntime.convertFieldToBytes(32,
                                                                                  _x2_0,
                                                                                  'battleship-simple.compact line 66 char 36'),
                                             _sk_0);
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
                                       ...
                                       { ins: { cached: false, n: 1 } },
                                       { ins: { cached: true, n: 1 } }]);
    const localBoardState_0 = this._setBoard_0(context,
                                               partialProofData,
                                               _x1_0,
                                               _x2_0);
  ...
  _setBoard_0(context, partialProofData, _x1_0, _x2_0) {
    const witnessContext_0 = __compactRuntime.createWitnessContext(ledger(context.currentQueryContext.state), context.currentPrivateState, context.currentQueryContext.address);
    const [nextPrivateState_0, result_0] = this.witnesses.setBoard(witnessContext_0,
                                                                   _x1_0,
                                                                   _x2_0);
    context.currentPrivateState = nextPrivateState_0;
    if (!(typeof(result_0) === 'number' && result_0 >= 0 && result_0 <= 1)) {
      __compactRuntime.typeError('setBoard',
                                 'return value',
                                 'battleship-simple.compact line 50 char 1',
  ...
  _checkBoard_0(context, partialProofData, x_0) {
    const witnessContext_0 = __compactRuntime.createWitnessContext(ledger(context.currentQueryContext.state), context.currentPrivateState, context.currentQueryContext.address);
    const [nextPrivateState_0, result_0] = this.witnesses.checkBoard(witnessContext_0,
                                                                     x_0);
    context.currentPrivateState = nextPrivateState_0;
    if (!(typeof(result_0) === 'number' && result_0 >= 0 && result_0 <= 1)) {
      __compactRuntime.typeError('checkBoard',
                                 'return value',
  ...
  _acceptGame_0(context, partialProofData, _x1_0, _x2_0, _sk_0) {
    ...
    const hash1_0 = this._commitBoardSpace_0(__compactRuntime.convertFieldToBytes(32,
                                                                                  _x1_0,
                                                                                  'battleship-simple.compact line 89 char 36'),
                                             _sk_0);
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
    ...
    const hash2_0 = this._commitBoardSpace_0(__compactRuntime.convertFieldToBytes(32,
                                                                                  _x2_0,
                                                                                  'battleship-simple.compact line 91 char 36'),
                                             _sk_0);
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
  ...
  _checkBoard1_0(context, partialProofData, _sk_0) {
    ...
    const honestyCheckHash_0 = this._commitBoardSpace_0(__compactRuntime.convertFieldToBytes(32,
                                                                                             currentShot_0,
                                                                                             'battleship-simple.compact line 139 char 47'),
                                                        _sk_0);
    const shotState_0 = this._checkBoard_0(context,
                                           partialProofData,
                                           currentShot_0);
  ...
  _checkBoard2_0(context, partialProofData, _sk_0) {
    ...
    const honestyCheckHash_0 = this._commitBoardSpace_0(__compactRuntime.convertFieldToBytes(32,
                                                                                             currentShot_0,
                                                                                             'battleship-simple.compact line 177 char 47'),
                                                        _sk_0);
    const shotState_0 = this._checkBoard_0(context,
                                           partialProofData,
                                           currentShot_0);
      ...
      member(...args_0) {
        ...
        if (!(elem_0.buffer instanceof ArrayBuffer && elem_0.BYTES_PER_ELEMENT === 1 && elem_0.length === 32)) {
          __compactRuntime.typeError('member',
                                     'argument 1',
                                     'battleship-simple.compact line 38 char 1',
                                     'Bytes<32>',
                                     elem_0)
        }
        return _descriptor_3.fromValue(__compactRuntime.queryLedgerState(context,
    ...
    board1Hits: {
      ...
      member(...args_0) {
        ...
        if (!(typeof(elem_0) === 'bigint' && elem_0 >= 0n && elem_0 <= 255n)) {
          __compactRuntime.typeError('member',
                                     'argument 1',
                                     'battleship-simple.compact line 44 char 1',
                                     'Uint<0..256>',
                                     elem_0)
        }
        return _descriptor_3.fromValue(__compactRuntime.queryLedgerState(context,
    ...
    board2Hits: {
      ...
      member(...args_0) {
        ...
        if (!(typeof(elem_0) === 'bigint' && elem_0 >= 0n && elem_0 <= 255n)) {
          __compactRuntime.typeError('member',
                                     'argument 1',
                                     'battleship-simple.compact line 45 char 1',
                                     'Uint<0..256>',
                                     elem_0)
        }
        return _descriptor_3.fromValue(__compactRuntime.queryLedgerState(context,
...
const _dummyContract = new Contract({
  setBoard: (...args) => undefined, checkBoard: (...args) => undefined
});
  ...
  publicKey: (...args_0) => {
    ...
    if (!(_sk_0.buffer instanceof ArrayBuffer && _sk_0.BYTES_PER_ELEMENT === 1 && _sk_0.length === 32)) {
      __compactRuntime.typeError('publicKey',
                                 'argument 1',
                                 'battleship-simple.compact line 206 char 1',
                                 'Bytes<32>',
                                 _sk_0)
    }
